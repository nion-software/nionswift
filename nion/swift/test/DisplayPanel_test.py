...
class TestDisplayPanelClass(unittest.TestCase):
    ...
    def test_line_plot_initially_displays_entire_data_in_horizontal_direction(self):
        ...
        self.assertEqual(line_plot_canvas_item.line_graph_canvas_item._data_info.x_properties.drawn_left_channel, 0)
        self.assertEqual(line_plot_canvas_item.line_graph_canvas_item._data_info.x_properties.drawn_right_channel, 1024)

    def test_line_plot_initially_displays_entire_data_in_vertical_direction(self):
        line_plot_canvas_item = self.setup_line_plot()
        self.assertEqual(line_plot_canvas_item.line_graph_canvas_item._data_info.y_properties.uncalibrated_data_min, 0.0)
        self.assertEqual(line_plot_canvas_item.line_graph_canvas_item._data_info.y_properties.uncalibrated_data_max, 1.0)
    ...
    def test_mouse_tracking_moves_vertical_scale_with_calibrated_data_with_offset(self):
        ...
        line_plot_canvas_item.continue_tracking(Geometry.IntPoint(x=30, y=240), modifiers)
        line_plot_canvas_item.end_tracking(modifiers)
        uncalibrated_data_min = line_plot_canvas_item.line_graph_canvas_item._data_info.y_properties.uncalibrated_data_min
        uncalibrated_data_max = line_plot_canvas_item.line_graph_canvas_item._data_info.y_properties.uncalibrated_data_max
    ...
    def test_mouse_tracking_moves_log_vertical_scale_with_uncalibrated_data(self):
        ...
        line_plot_canvas_item.continue_tracking(Geometry.IntPoint(x=30, y=240), modifiers)
        line_plot_canvas_item.end_tracking(modifiers)
        data_info = line_plot_canvas_item.line_graph_canvas_item._data_info
    ...
    def test_browser_context_menu_deletes_all_selected_items(self):
        ...
        self.document_controller.periodic()
        self.document_controller.selection.set_multiple([0, 1, 2, 3])
