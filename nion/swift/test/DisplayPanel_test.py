...
class TestDisplayPanelClass(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.display_panel.layout_immediate(Geometry.IntSize(1000 + header_height, 1000))
    ...
    def test_delete_key_when_graphic_selected_removes_the_graphic(self):
        ...
        # focus click
        self.display_panel.simulate_click((500, 500), modifiers)  # click on graphic
        # check assumptions
        self.assertEqual(len(self.display_item.graphics), 1)
        self.assertEqual(len(self.display_item.graphic_selection.indexes), 1)
        # do focusing click, then delete
        self.display_panel._handle_key_pressed(TestUI.Key(None, "delete", modifiers))
        # check results
    ...
    def test_mouse_tracking_moves_vertical_scale_with_calibrated_data_with_offset(self):
        ...
        line_plot_canvas_item.update_canvas_items()
    ...
    def test_combined_horizontal_drag_and_expand_works_nominally(self):
        ...
        line_plot_canvas_item.update_canvas_items()  # update after the expansion, but before the move.
        # continue
    ...
    def test_click_drag_interval_end_channel_to_right_adjust_end_channel(self):
        ...
        self.document_controller.periodic()
        # make sure results are correct
        line_plot_canvas_item.refresh_layout_immediate()
    ...
    def test_enter_to_auto_display_limits(self):
        ...
        modifiers = CanvasItem.KeyboardModifiers()
        self.display_panel.simulate_click((100, 100), modifiers)
        self.display_panel._handle_key_pressed(TestUI.Key(None, "enter", modifiers))
    ...
    def test_image_display_panel_produces_context_menu_with_correct_item_count(self):
        ...
        # show, sep, delete, sep, split h, split v, sep, none, sep, data, thumbnails, browser, detail, sep
        self.assertEqual(24, len(self.document_controller.ui.popup.items))
    ...
    def test_image_display_panel_with_no_image_produces_context_menu_with_correct_item_count(self):
        ...
        self.display_panel.refresh_layout_immediate()
        self.display_panel._context_menu_event_for_testing(500, 500)
        # reveal, export, sep, del, sep, split h, split v, sep, none, sep, data, thumbnails, browser, detail, sep
        self.assertEqual(16, len(self.document_controller.ui.popup.items))
    ...
    def test_browser_context_menu_deletes_all_selected_items(self):
        with TestContext.create_memory_context() as test_context:
            ...
            display_panel._context_menu_event_for_testing(40, 40)
            document_controller.periodic()
    ...
    def test_adding_fourier_filter_is_undoable_via_menu_items(self):
        with TestContext.create_memory_context() as test_context:
            ...
            # focus click
            display_panel.simulate_click((500, 500), CanvasItem.KeyboardModifiers())
            # add fourier graphic
