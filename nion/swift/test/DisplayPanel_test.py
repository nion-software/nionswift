...
class TestDisplayPanelClass(unittest.TestCase):
    ...
    def test_move_display_layer_from_display_to_display_undo_redo(self):
        with TestContext.create_memory_context() as test_context:
            ...
            display_item4.append_display_data_channel(DisplayItem.DisplayDataChannel(data_item=data_item5), display_layer=dict())
    ...
    def test_add_display_layer_undo_redo(self):
        with TestContext.create_memory_context() as test_context:
            ...
            self.assertEqual(2, len(display_item1.display_data_channels))
            self.assertEqual(0, display_item1.get_display_layer_property(0, "data_index"))
            self.assertEqual(0, display_item1.get_display_layer_property(1, "data_index"))
            self.assertEqual(1, display_item1.get_display_layer_property(2, "data_index"))
            command.undo()
            self.assertEqual(2, len(display_item1.display_layers))
            self.assertEqual(2, len(display_item1.display_data_channels))
            self.assertEqual(0, display_item1.get_display_layer_property(0, "data_index"))
