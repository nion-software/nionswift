...
class TestDocumentControllerClass(unittest.TestCase):
    ...
    def test_creating_with_variable_produces_valid_computation(self):
        with TestContext.create_memory_context() as test_context:
            ...
            document_model.append_data_item(data_item)
            display_item = document_model.get_display_item_for_data_item(data_item)
            data_item_r, display_item_r = document_model.assign_variable_to_display_item(display_item)
    ...
    def test_extra_variables_in_computation_get_purged(self):
        with TestContext.create_memory_context() as test_context:
            ...
            data_item_r, display_item_r = document_model.assign_variable_to_display_item(display_item)
            data_item_r2, display_item_r2 = document_model.assign_variable_to_display_item(display_item2)
