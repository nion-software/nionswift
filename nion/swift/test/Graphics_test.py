...
class TestGraphicsClass(unittest.TestCase):
    ...
    def test_rect_test(self):
        ...
        self.assertEqual(rect_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((500, 500)), move_only=False), ("all", False))
        self.assertEqual(rect_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((250, 250)), move_only=False)[0], "top-left")
        self.assertEqual(rect_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((750, 750)), move_only=False)[0], "bottom-right")
        self.assertEqual(rect_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((250, 750)), move_only=False)[0], "top-right")
        self.assertEqual(rect_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((750, 250)), move_only=False)[0], "bottom-left")
        self.assertEqual(rect_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((250, 500)), move_only=False), ("all", True))
        self.assertEqual(rect_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((750, 500)), move_only=False), ("all", True))
        self.assertEqual(rect_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((500, 250)), move_only=False), ("all", True))
        self.assertEqual(rect_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((500, 750)), move_only=False), ("all", True))
        self.assertIsNone(rect_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint(), move_only=False)[0])
        rect_graphic.close()
    ...
    def test_line_test(self):
        ...
        ui_settings = DisplayPanel.FixedUISettings()
        drawing_metrics = UISettings.DrawingMetrics(ui_settings=ui_settings, ppi=96.0)
        self.assertEqual(line_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((500, 500)), move_only=True)[0], "all")
        self.assertEqual(line_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((250, 250)), move_only=True)[0], "start")
        self.assertEqual(line_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((750, 750)), move_only=True)[0], "end")
        self.assertEqual(line_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((250, 250)), move_only=False)[0], "start")
        self.assertEqual(line_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((750, 750)), move_only=False)[0], "end")
        self.assertIsNone(line_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((240, 240)), move_only=False)[0])
        self.assertIsNone(line_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((760, 760)), move_only=False)[0])
        self.assertIsNone(line_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint(), move_only=False)[0])
        line_graphic.close()
    ...
    def test_spot_test(self):
        ...
        ui_settings = DisplayPanel.FixedUISettings()
        drawing_metrics = UISettings.DrawingMetrics(ui_settings=ui_settings, ppi=96.0)
        self.assertEqual(spot_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((200, 200)), move_only=False), ("top-left", True))
        self.assertEqual(spot_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((300, 200)), move_only=False), ("bottom-left", True))
        self.assertEqual(spot_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((300, 300)), move_only=False), ("bottom-right", True))
        self.assertEqual(spot_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((200, 300)), move_only=False), ("top-right", True))
        self.assertEqual(spot_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((185, 250)), move_only=False), ("rotate", True))
        self.assertEqual(spot_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((800, 800)), move_only=False), ("inverted-bottom-right", True))
        self.assertEqual(spot_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((700, 800)), move_only=False), ("inverted-top-right", True))
        self.assertEqual(spot_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((700, 700)), move_only=False), ("inverted-top-left", True))
        self.assertEqual(spot_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((800, 700)), move_only=False), ("inverted-bottom-left", True))
        self.assertEqual(spot_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint.make((815, 750)), move_only=False), ("inverted-rotate", True))
        self.assertIsNone(spot_graphic.test(mapping, drawing_metrics, Geometry.FloatPoint(), move_only=False)[0])
        spot_graphic.close()
