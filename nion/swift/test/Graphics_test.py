...
class TestGraphicsClass(unittest.TestCase):
    ...
    def test_spot_test(self):
        ...
        self.assertEqual(spot_graphic.test(mapping, ui_settings, Geometry.FloatPoint.make((185, 250)), move_only=False), ("rotate", True))
        self.assertEqual(spot_graphic.test(mapping, ui_settings, Geometry.FloatPoint.make((800, 800)), move_only=False), ("inverted-bottom-right", True))
        self.assertEqual(spot_graphic.test(mapping, ui_settings, Geometry.FloatPoint.make((700, 800)), move_only=False), ("inverted-top-right", True))
        self.assertEqual(spot_graphic.test(mapping, ui_settings, Geometry.FloatPoint.make((700, 700)), move_only=False), ("inverted-top-left", True))
        self.assertEqual(spot_graphic.test(mapping, ui_settings, Geometry.FloatPoint.make((800, 700)), move_only=False), ("inverted-bottom-left", True))
        self.assertEqual(spot_graphic.test(mapping, ui_settings, Geometry.FloatPoint.make((815, 750)), move_only=False), ("inverted-rotate", True))
