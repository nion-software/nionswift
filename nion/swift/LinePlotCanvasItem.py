...
class LinePlotCanvasItem(DisplayCanvasItem.DisplayCanvasItem):
    ...
    def __init__(self, drawing_metrics: UISettings.DrawingMetrics,
        ...
        self.__line_graph_layers_canvas_item = LineGraphCanvasItem.LineGraphLayersCanvasItem(self.__drawing_metrics)
        self.__line_graph_regions_canvas_item = LineGraphCanvasItem.LineGraphRegionsCanvasItem(self.__drawing_metrics, self.__display_style)
        self.__line_graph_background_canvas_item = LineGraphCanvasItem.LineGraphBackgroundCanvasItem(self.__drawing_metrics)
        ...
        self.__line_graph_legend_canvas_item = LineGraphCanvasItem.LineGraphLegendCanvasItem(self.__drawing_metrics, self.__display_style, typing.cast(LineGraphCanvasItem.LineGraphLegendCanvasItemDelegate, delegate))
        ...
        self.__line_graph_outer_left_column.layout = CanvasItem.CanvasItemColumnLayout(margins=Geometry.Margins(int(self.drawing_metrics.scale_length(16)), int(self.drawing_metrics.scale_length(16)), 0, 0))
        self.__line_graph_outer_left_legend = LineGraphCanvasItem.LineGraphLegendCanvasItem(self.__drawing_metrics, self.__display_style, typing.cast(LineGraphCanvasItem.LineGraphLegendCanvasItemDelegate, delegate))
        ...
        self.__line_graph_outer_right_column.layout = CanvasItem.CanvasItemColumnLayout(margins=Geometry.Margins(int(self.drawing_metrics.scale_length(16)), 0, 0, int(self.drawing_metrics.scale_length(16))))
        self.__line_graph_outer_right_legend = LineGraphCanvasItem.LineGraphLegendCanvasItem(self.__drawing_metrics, self.__display_style, typing.cast(LineGraphCanvasItem.LineGraphLegendCanvasItemDelegate, delegate))
        ...
        self.__line_graph_frame_canvas_item = LineGraphCanvasItem.LineGraphFrameCanvasItem(self.__drawing_metrics)
        ...
        self.__line_graph_vertical_axis_label_canvas_item = LineGraphCanvasItem.LineGraphVerticalAxisLabelCanvasItem(self.__drawing_metrics, self.__display_style)
        self.__line_graph_vertical_axis_scale_canvas_item = LineGraphCanvasItem.LineGraphVerticalAxisScaleCanvasItem(self.__drawing_metrics, self.__display_style)
        self.__line_graph_vertical_axis_ticks_canvas_item = LineGraphCanvasItem.LineGraphVerticalAxisTicksCanvasItem(self.__drawing_metrics)
        ...
        self.__line_graph_horizontal_axis_label_canvas_item = LineGraphCanvasItem.LineGraphHorizontalAxisLabelCanvasItem(self.__drawing_metrics, self.__display_style)
        self.__line_graph_horizontal_axis_scale_canvas_item = LineGraphCanvasItem.LineGraphHorizontalAxisScaleCanvasItem(self.__drawing_metrics, self.__display_style)
        self.__line_graph_horizontal_axis_ticks_canvas_item = LineGraphCanvasItem.LineGraphHorizontalAxisTicksCanvasItem(self.__drawing_metrics)
        ...
        margins = Geometry.Margins(left=int(self.drawing_metrics.scale_length(6)), right=int(self.drawing_metrics.scale_length(12)), top=font_size + int(self.drawing_metrics.scale_length(4)), bottom=int(self.drawing_metrics.scale_length(6)))
                ...
                if h_axis_canvas_bounds and h_axis_canvas_bounds.contains_point(self.map_to_canvas_item(pos, self.line_graph_horizontal_axis_group_canvas_item)):
                    ...
                    for graphic_index, graphic in enumerate(graphics):
                        if graphic.has_attribute(Graphics.GraphicAttributeEnum.ONE_DIMENSIONAL):
                            ...
                            part, specific = graphic.test(widget_mapping, self.__drawing_metrics, self.display_style, pos.to_float_point(), False)
        ...
        if axes and graphic_selection:
            ...
            for graphic_index, graphic in enumerate(graphics):
                if graphic.has_attribute(Graphics.GraphicAttributeEnum.ONE_DIMENSIONAL):
                    ...
                    widget_mapping = self.__get_mouse_mapping()
                    part, specific = graphic.test(widget_mapping, self.__drawing_metrics, self.display_style, self.__graphic_drag_start_pos.to_float_point(), move_only)
                    if part:
        ...
        if self.__tracking_selections:
            if self.__graphic_drag_item is None and not self.__graphic_drag_changed and graphic_selection:
                ...
                if not self.__pending_interval:
                    ...
                    region = None
                elif abs(widget_mapping.map_point_channel_norm_to_widget(self.__pending_interval.start) - pos.x) > self.__drawing_metrics.cursor_tolerance:
