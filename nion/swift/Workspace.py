...
class Workspace:
    ...
    def get_workspace_rect(self) -> Geometry.IntRect | None:
        """Get the bounds of the workspace area using the canvas items widget and bounds.

        The rectangle is mapped to the global origin.
        Returns None when the canvas item has invalid bounds or widget.
        """
        ...
        if canvas_bounds is None or canvas_widget is None:
            return None
    ...
    def apply_layouts(self, primary_display_panel: DisplayPanel.DisplayPanel, display_panels: typing.Sequence[DisplayPanel.DisplayPanel], w: int, h: int) -> list[DisplayPanel.DisplayPanel]:
        ...
        for display_panel in display_panels:
            ...
            row_display_panels = list[DisplayPanel.DisplayPanel]()
            ...
            if w > 1:
                for row_display_panel in row_display_panels:
                    ...
                    for column in range(1, w):
                        ...
                        self.__insert_display_panel(self.__display_panels.index(last_display_panel) + 1, column_display_panel)
