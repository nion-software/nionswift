...
def make_color_map_chooser(ui, display):
    ...
    color_map_chooser.on_current_item_changed = lambda item: setattr(display, "color_map", item[1])
    color_map_chooser.current_item = color_map_options[color_map_reverse_map.get(display.color_map, 0)]
