...
class PersistentProperty:
    ...
    def __init__(self, name: str, value: typing.Any = None, make: typing.Optional[_PropertyMakeFn] = None,
                 ...
                 value_type: typing.Optional[typing.Type[typing.Any]] = None,
                 is_equal_fn: typing.Optional[typing.Callable[[typing.Any, typing.Any], bool]] = None) -> None:
        super().__init__()
        self.name = name
        ...
        self.is_equal = is_equal_fn if is_equal_fn else is_equal_map.get(value_type, is_equal)
    ...
    def _set_value(self, value: typing.Any, validate: bool) -> tuple[bool, typing.Any]:
        ...
        self.value = value
        return did_change, value

    def _set_value_call_changed(self, value: typing.Any) -> None:
...
class PersistentObject(Observable.Observable):
    ...
    def define_property(self, name: str, value: typing.Any = None, make: typing.Optional[_PropertyMakeFn] = None,
        ...
        if copy_on_read:
            ...
            self.__properties[name] = PersistentProperty(name, value, make, read_only, hidden, recordable, validate, converter, changed, key, reader, writer, value_type, is_equal_fn)
    ...
    def _set_persistent_property_value(self, name: str, value: typing.Any, force_update: bool = False, validate: bool = True) -> None:
        ...
        if did_change or force_update:
            ...
            if did_change:
                property._set_value_call_changed(value)
