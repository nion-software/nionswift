...
class Graphic(Persistence.PersistentObject):
    ...
    # Setting default stroke and fill colors so that Inspector accurately reflects color of Graphic
...
class IntervalGraphic(Graphic):
    def __init__(self) -> None:
        ...
        self._set_persistent_property_value("stroke_color", self._default_stroke_color)
        self.notify_property_changed("stroke_color")
