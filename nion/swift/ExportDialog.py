...
class ExportDialogViewModel:
    ...
    def handle_options_changed(self, prefix_value: str | None = None) -> None:
        """Directly refresh the validity of the export button's enabled state and tooltip."""
        self.__handle_export_options_validity_changed(self.__compute_export_options_validity(prefix_value or self.prefix.value, self.include_title.value,
...
class ExportDialog(Declarative.Handler):
    ...
    def prefix_edited(self, widget: UserInterface.LineEditWidget, text: str) -> None:
        self.viewmodel.handle_options_changed(text)
    ...
    def __build_ui(self, u: Declarative.DeclarativeUI) -> None:
        ...
        prefix_textbox = u.create_line_edit(text="@binding(viewmodel.prefix.value)", placeholder_text=_("None"), width=230, on_text_edited="prefix_edited")
