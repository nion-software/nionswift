...
* Fix issue with dragging spot graphic. [nion-software/nionswift#1602](https://github.com/nion-software/nionswift/issues/1602), [nion-software/nionswift#1683](https://github.com/nion-software/nionswift/issues/1683)
...
* (2019-12-30) Allow spot graphics to be elliptical and rotatable.
...
----------------------------
* (2018-06-29) Fix regression where band-pass graphic inspector was not available.
...
* Add band-pass graphic (experimental).
...
* Add spot graphic and angular graphics (experimental). Add Fourer Filter menu item.
