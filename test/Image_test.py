...
class TestImageClass(unittest.TestCase):
    ...
    def test_create_rgba_image_from_array(self):
        ...
        self.assertIsNotNone(Image.createRGBAImageFromArray(image_1d_16))
        self.assertIsNotNone(Image.createRGBAImageFromArray(image_1d_16x1))
        image_1d_rgb = numpy.zeros((16, 3), dtype=numpy.uint8)
        self.assertIsNotNone(Image.createRGBAImageFromArray(image_1d_rgb))
