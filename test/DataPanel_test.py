...
class TestDataPanelClass(unittest.TestCase):
    ...
    def test_image_panel_delete(self):
        ...
        data_panel.data_group_model_controller.current_item_changed(0, -1, 0)
    ...
    def test_selected_data_item_persistence(self):
        ...
        data_panel = DataPanel.DataPanel(document_controller, "data-panel", {})
        self.assertEqual(data_panel.data_group_model_controller._parent_id, 0)
        self.assertEqual(data_panel.data_group_model_controller._parent_row, -1)
        self.assertEqual(data_panel.data_group_model_controller._index, -1)
        self.assertEqual(data_panel.data_item_model_controller._index, -1)
        document_controller.selected_image_panel = image_panel1
        self.assertEqual(data_panel.data_group_model_controller._parent_id, 1)
        self.assertEqual(data_panel.data_group_model_controller._parent_row, 0)
        self.assertEqual(data_panel.data_group_model_controller._index, 0)
    ...
    def test_selected_group_persistence(self):
        ...
        document_controller.selected_image_panel = image_panel1
        data_panel.data_group_model_controller.current_item_changed(1, 0, 1)
        data_panel.data_item_model_controller.current_item_changed(-1)
    ...
    def test_selection_during_operations(self):
        ...
        self.assertEqual(data_panel.data_group_model_controller.data_panel_selection.data_group, data_group1)
